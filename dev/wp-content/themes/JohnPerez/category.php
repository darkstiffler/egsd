											...
											<div class="post">
                                                ...
                                                <div class="contentBlog">
                                                    ...
                                                    <div class="post">
                                                        ...
                                                        <a href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail() ) { the_post_thumbnail( 'custom-size8' );  }; ?></a>
                                                        ...
                                                        <div class="txt-post">
                                                            ...
                                                            <h2 class="post" ><a href="<?php the_permalink() ?>" class="titl"><?php the_title(); ?></a></h2>
													 ...
													 <a href="#"><?php comments_popup_link('0 comments', '1 comments', '(%) comments');?> </a>, in <?php the_category(', '); ?></div>
