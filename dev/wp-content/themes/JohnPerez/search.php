          ...
          <h2>Search Results</h2>
            ...
            <?php
                        ...
                        <div class="post">
                            ...
                            <?php $config = get_option( 'blog_featured' ); 
                            if ($config == 'yes') {
                            ?>
                            <a href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail() ) { the_post_thumbnail( $meta_thumbsize ); }; ?></a>
                            <?php } ?>
                            <div class="txt-post">
                                <div class="fl"><?php the_time('d')?><br><i><?php the_time('M') ?></i></div>
                                <h4><a href="<?php the_permalink() ?>" class="titl"><?php the_title(); ?></a></h4>
                                <?php the_excerpt(); ?>
                            </div>
                            ...
                            <div class="bot-post">
                                ...
                                ?>, by <?php the_author();?>, <?php comments_popup_link('Leave a Comment', 'Comments (1)', 'Comments (%)'); ?>
                            </div>
                        </div>
		                  <?php endwhile; endif; ?>
            ...
            <div class="load-more botMore"> 
                <?php next_posts_link( __('Show more posts', '') ); ?>
            </div>
            <?php } ?>
