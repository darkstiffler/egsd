        	...
        	<div class="pad_box4">           
            	...
            	<div class="contentBlog">
                	...
                	<div class="wrapper blog_content">
                        ...
                        <?php
                          ...
                          query_posts($query);
							...
							if($category[0]->cat_name != 'Unpublished') {
								...
								<?php           
                                          ...
                                          if ($meta_blogvideoservice == 'vimeo') { 
                                           ...
                                           ?> 
                                            ...
                                            <p><iframe src="http://player.vimeo.com/video/<?php echo $meta_blogvideourl; ?>?js_api=1&amp;js_onLoad=player<?php echo $meta_blogvideourl; ?>_1798970533.player.moogaloopLoaded" width="100%" height="203" allowFullScreen></iframe></p>
                                          ...
                                          ?>
                                            ...
                                            <p><iframe width="100%" height="203" src="http://www.youtube.com/embed/<?php echo $meta_blogvideourl; ?>"  allowfullscreen></iframe></p>
										  ...
										  <video id="my_video_1" class="video-js vjs-default-skin" controls
											  ...
											  preload="auto" width="100%" height="203" poster="<?php echo $img_url[0]; ?>"
                    ...
                    ?> 
                                        ...
                                        <h2><a class="testid" href="<?php the_permalink(); ?>" ><?php
