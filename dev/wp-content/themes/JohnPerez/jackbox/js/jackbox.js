...
;(function($) {
	...
	swfPlayer = baseName + "/modules/jackbox_swf.html",
	
	// The url to the fallback thumbnail
	defaultThumb = baseName + "/img/thumbs/default.jpg",
	
	// The url to the video player module
	videoPlayer = baseName + "/modules/jackbox_video.html",
	
	// The url to the audio player module
	audioPlayer = baseName + "/modules/jackbox_audio.html",
	
	// The url to the social buttons module
	socialbuttons = baseName + "/modules/jackbox_social.php",
	...
	bottomMarkup = 
		...
		'<div class="jackbox-bottom clearfix">' + 
			...
			'<div class="jackbox-title-text">' + 
				...
				'<span class="jackbox-title-txt">'+title+'</span>' + 
