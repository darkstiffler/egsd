 ...
 * @subpackage Widgets
 */
function wp_widgets_init2() {
	if ( !is_blog_installed() )
		return;
	register_widget('WP_Widget_Archives2');
...
add_action('widgets_init', 'wp_widgets_init2');
 ...
 * @since 2.8.0
 */
class WP_Widget_Archives2 extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $title )
			 ?><h2 class="ind1"><?php echo $title  ?></h2><?php
...
class WP_Widget_Text2 extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		//echo $before_widget;
		?> <div class="white_box"><?php
		if ( !empty( $title ) ) { ?><h2 class="ind"><?php echo $title  ?></h2><?php } ?>
 ...
 * @since 2.8.0
 */
class WP_Widget_Categories2 extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( $title )
			?><h2 class="ind1"><?php echo $title  ?></h2>
