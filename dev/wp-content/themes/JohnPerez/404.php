...
<?php */?>
  ...
  <link rel="shortcut icon" href="<?php echo get_option('sense_site_icon'); ?>" type="image/x-icon" />
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/video-js/video-js.css" rel="stylesheet" />
	  ...
	  <div class="box p_bot1">
		<div class="grid_12 alpha omega">
		  <div class="pad_box3">
				...
				<h2>ERROR 404.<br> Sorry! The page you’re looking for cannot be found.</h2>
